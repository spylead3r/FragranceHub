...
namespace FragranceHub.Data.Migrations
{
    ...
    [Migration("20240413201600_CustomRegister")]
            ...
            modelBuilder.Entity("FragranceHub.Data.Models.Fragrance", b =>
                {
                    ...
                    b.Property<DateTime>("PublishedOnDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 13, 20, 15, 59, 750, DateTimeKind.Utc).AddTicks(1314));
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d8e50449-adc8-4460-9488-6884e2091333"),
                            CategoryId = 1,
