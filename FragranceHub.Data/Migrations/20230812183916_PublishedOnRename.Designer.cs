...
namespace FragranceHub.Data.Migrations
{
    ...
    [Migration("20230812183916_PublishedOnRename")]
    partial class PublishedOnRename
    {
            ...
            modelBuilder.Entity("FragranceHub.Data.Models.Fragrance", b =>
                {
                    ...
                    b.Property<DateTime>("PublishedOnDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 12, 18, 39, 15, 362, DateTimeKind.Utc).AddTicks(3004));
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("61b148e3-0a82-477f-afed-7903f7ffba56"),
                            CategoryId = 1,
